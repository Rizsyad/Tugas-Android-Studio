...
public class TampilSemuaMahasiswaActivity extends AppCompatActivity implements ListView.OnItemClickListener {
    ...
    private void showMahasiswa () {
        ...
        ListAdapter adapter = new SimpleAdapter(
                TampilSemuaMahasiswaActivity.this, list, R.layout.list_item,
    ...
    private void getJSON(){
        class GetJSON extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(TampilSemuaMahasiswaActivity.this,"Mengambil Data", "Mohon Tunggu...", false, false);
            }
            @Override
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        Intent intent = new Intent(this, TampilMahasiswaActivity.class);
        HashMap<String,String> map =(HashMap)parent.getItemAtPosition(position);
        String mhsid = map.get(Configuration.TAG_ID).toString();
        intent.putExtra(Configuration.MHS_ID, mhsid);
