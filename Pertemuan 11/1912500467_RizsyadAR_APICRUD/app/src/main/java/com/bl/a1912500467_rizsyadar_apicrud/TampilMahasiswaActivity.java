...
public class TampilMahasiswaActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void getMahasiswa () {
        class GetMahasiswa extends AsyncTask<Void, Void, String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(TampilMahasiswaActivity.this, "Fetching...", "Wait...", false, false);
            }
            ...
            protected String doInBackground (Void... params){
                ...
                String s = rh.sendGetRequestParam(Configuration.URL_GET_MHS, id);
                return s;
            }
        }
    ...
    private void updateMahasiswa(){
        ...
        class UpdateMahasiswa extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute(){
                super.onPreExecute();
                loading = ProgressDialog.show(TampilMahasiswaActivity.this, "Updating...", "Wait...", false, false);
            }
            ...
            protected void onPostExecute(String s) {
                super.onPostExecute(s);
                loading.dismiss();
                Toast.makeText(TampilMahasiswaActivity.this,s,Toast.LENGTH_LONG).show();
            }
    ...
    private void deleteMahasiswa(){
        ...
        class DeleteMahasiswa extends AsyncTask<Void,Void,String> {
            ...
            protected String doInBackground(Void... params) {
                RequestHandler rh = new RequestHandler();
                String s = rh.sendGetRequestParam(Configuration.URL_DELETE_MHS, id);
                return s;
            }
        }
    ...
    private void confirmDeleteMahasiswa(){
        ...
        alertDialogBuilder.setPositiveButton("Ya", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                deleteMahasiswa();
                startActivity(new Intent(TampilMahasiswaActivity.this, TampilSemuaMahasiswaActivity.class));
            }
        });
